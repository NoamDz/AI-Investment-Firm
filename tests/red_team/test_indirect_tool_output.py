"""Red-team class: indirect_tool_output.
...
NOTE: Cases targeting 'research' (indirect_tool_output_1, _2) exercise harness
wiring only; payload_text is not injected into the legacy stub research path.
Those cases pass vacuously — the real grounded-retriever attack surface lands
in a later task.
"""
...
_CLASS_SLUG = "indirect_tool_output"
...
def test_indirect_tool_output_invariant(case: RedTeamCase, red_team_ctx: RedTeamCtx) -> None:
